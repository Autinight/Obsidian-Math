...
>
> - If the space $X$ can be covered by open subsets which are evenly covered by $p$, then we say that $p$ is a **covering projection**; the space $\overline{X}$ is called a covering space of $X$.
