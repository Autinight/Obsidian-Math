...
% === 对角箭头 α, β, γ (从前层到后层，同一索引) ===
\draw[->,red,thick] (An1) -- (Apn1) node[midway,above] {\small$\alpha$};
\draw[->,red,thick] (An) -- (Apn) node[midway,above] {\small$\alpha$};
\draw[->,red,thick] (Anm1) -- (Apnm1) node[midway,above] {\small$\alpha$};

\draw[->,blue,thick] (Bn1) -- (Bpn1) node[midway,above] {\small$\beta$};
\draw[->,blue,thick] (Bn) -- (Bpn) node[midway,above] {\small$\beta$};
\draw[->,blue,thick] (Bnm1) -- (Bpnm1) node[midway,above] {\small$\beta$};

\draw[->,green!60!black,thick] (Cn1) -- (Cpn1) node[midway,above] {\small$\gamma$};
\draw[->,green!60!black,thick] (Cn) -- (Cpn) node[midway,above] {\small$\gamma$};
\draw[->,green!60!black,thick] (Cnm1) -- (Cpnm1) node[midway,above] {\small$\gamma$};
...
\cdots \arrow[r] & H_n(A) \arrow[r, "i_*"] \arrow[d, "\alpha_*"] & H_n(B) \arrow[r, "j_*"] \arrow[d, "\beta_*"] & H_n(C) \arrow[r, "\partial"] \arrow[d, "\gamma_*"] & H_{n-1}(A) \arrow[r] \arrow[d, "\alpha_*"] & \cdots \\
\cdots \arrow[r] & H_n(A') \arrow[r, "i'_*"] & H_n(B') \arrow[r, "j'_*"] & H_n(C') \arrow[r, "\partial"] & H_{n-1}(A') \arrow[r] & \cdots
\end{tikzcd}
\end{document}
```
