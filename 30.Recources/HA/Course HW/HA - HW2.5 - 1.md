...
>      $$ \begin{aligned} S_{n}&=\frac{1}{2}+  \sum _{k= 1}^{n}\cos kx \\&= \frac{1}{2}+ \frac{1 }{\sin \frac{1}{2}x }\sum _{k= 1}^{n}\cos kx\sin \frac{1}{2}x\\&= \frac{1}{2}+ \frac{1 }{\sin \frac{1}{2}x }\sum _{k= 1}^{n}\left(\sin \left(\left(k+ \frac{1 }{2 }\right)x\right)-\sin \left(\left(k-\frac{1}{2}\right)x\right)\right)\\&= \frac{1}{2}+ \frac{1}{2}\frac{1 }{\sin \frac{1}{2}x }\left(-\sin \frac{1}{2}x+ \sin \left(\left(n+ \frac{1}{2}\right)x\right)\right)\\&= \frac{1}{2}\frac{\sin \left(\left(n+ \frac{1}{2}\right)x\right) }{\sin \frac{1}{2}x }\end{aligned}$$
>      继而
...
>      广义和为零. 
> 2. 
> 当$k= \pi$或$k= -\pi$时, 显然级数和为零, 进而广义和也为零.
