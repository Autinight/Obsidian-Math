...
下面按“对丘赛（几何方向）训练核心能力”的优先级，把这组题分成 **High / Medium / Low**（High≈必做，Medium≈选做，Low≈有余力再做/偏拓展）。
